...
<center>
  <!-- LOGIN FORM -->
<div id=="loginp" class="text-center" style="padding:50px 0">
	...
	<div class="login-form-1">
		...
		<form id="login-form" class="text-left">
          ...
          <div class="social-buttons " >
            <a href="#" class="btn btn-fb" role="button"><i class="fa fa-facebook"></i> Facebook</a>
            <a href="#" class="btn btn-tw"><i class="fa fa-linkedin"></i>  LinkedIn </a>
          </div>
